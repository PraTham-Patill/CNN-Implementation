...
def run_experiment(dataset_name):
    ...
    print(f"\n{'='*50}")
    print(f"Running LeNet Dropout - {dataset_name.upper()} Dataset")
    print(f"{'='*50}")
...
Regularization Used: Dropout (rate = {dropout_rate})
Plot: {plot_filename}
============================="""
...
def main():
    ...
    print("Starting LeNet Dropout Model Training...")
