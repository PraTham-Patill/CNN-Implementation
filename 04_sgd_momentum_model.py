...
def run_experiment(dataset_name):
    ...
    print(f"\n{'='*50}")
    print(f"Running LeNet SGD + Momentum - {dataset_name.upper()} Dataset")
    print(f"{'='*50}")
    ...
    # Save plot
    plot_filename = f'sgd_momentum_{dataset_name.lower()}_results.png'
    plot_results(train_losses, val_losses, train_accs, val_accs, plot_filename)
    
    # Append detailed report
    report_content = f"""=============================
Experiment: LeNet with SGD + Momentum
...
Regularization Used: SGD with Momentum (momentum = {momentum})
Plot: {plot_filename}
============================="""
...
def main():
    ...
    print("Starting LeNet SGD + Momentum Model Training...")
