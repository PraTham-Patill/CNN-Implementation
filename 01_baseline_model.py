...
def run_experiment(dataset_name):
    ...
    print(f"\n{'='*50}")
    print(f"Running LeNet Baseline - {dataset_name.upper()} Dataset")
    print(f"{'='*50}")
    ...
    # Save plot
    plot_filename = f'baseline_{dataset_name.lower()}_results.png'
    plot_results(train_losses, val_losses, train_accs, val_accs, plot_filename)
    
    # Append detailed report
    report_content = f"""=============================
Experiment: LeNet Baseline (No Regularization)
...
def main():
    ...
    print("Starting LeNet Baseline Model Training...")
