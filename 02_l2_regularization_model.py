...
def run_experiment(dataset_name):
    ...
    print(f"\n{'='*50}")
    print(f"Running LeNet L2 Regularization - {dataset_name.upper()} Dataset")
    print(f"{'='*50}")
    ...
    # Model setup with L2 regularization
    model = LeNet(num_classes=num_classes, input_channels=input_channels).to(device)
    ...
    # Save plot
    plot_filename = f'l2_regularization_{dataset_name.lower()}_results.png'
    plot_results(train_losses, val_losses, train_accs, val_accs, plot_filename)
    
    # Append detailed report
    report_content = f"""=============================
Experiment: LeNet with L2 Regularization
...
Regularization Used: L2 (Weight Decay = {weight_decay})
Plot: {plot_filename}
============================="""
...
def main():
    ...
    print("Starting LeNet L2 Regularization Model Training...")
